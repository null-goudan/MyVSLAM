...
namespace Goudan_SLAM
{
    ...
    Tracking::Tracking(System *pSys, ORBVocabulary *pVoc, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap, KeyFrameDatabase *pKFDB, const string &strSettingPath) : mState(NO_IMAGES_YET), mbOnlyTracking(false), mbVO(false), mpORBVocabulary(pVoc),
    ...
    void System::Shutdown()
    {
        ...
        if (mpViewer)
            pangolin::BindToContext("Goudan-SLAM: Map Viewer");
    }
} // namespace Goudan_SLAM
